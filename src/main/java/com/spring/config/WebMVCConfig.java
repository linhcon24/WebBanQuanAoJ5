...
public class WebMVCConfig implements WebMvcConfigurer {
	...
	public MessageSource messageSource() {
		...
		source.addBasenames("classpath:i18n/label", "classpath:message/validation");
	...
	public LocaleResolver localeResolver() {
		...
		resolver.setCookieMaxAge(1 * 24 * 60 * 60);
//		resolver.setCookieMaxAge(60 * 60 * 24 * 7);
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(loginInterceptor).addPathPatterns("/admin/**", "/category/**", "/users/**", "/cart/**")
				.excludePathPatterns("/product", "/info", "/detail", "/index", "/register");
		registry.addInterceptor(userInterceptor).addPathPatterns("/admin/**", "/category/**", "/users/**")
...
//					.excludePathPatterns("/admin/**" , "/category/**" , "/users/**");		
		registry.addInterceptor(adminInterceptor).addPathPatterns("/login");
	}
}

                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                          ...
                          <form:form modelAttribute="forget"  action="${pageContext.request.contextPath }/forget" method="POST">
                            ...
                            <div class="form-outline mb-4">
                              ...
                              <form:input class="form-control form-control-lg" name="username" path="username"/>
                            ...
                            <div class="form-outline mb-4">
                              ...
                              <form:input class="form-control form-control-lg" name="email" path="email" />

...
<%-- 						</c:if> --%>
                          <form:form modelAttribute="change"  action="${pageContext.request.contextPath }/change" method="POST">
                            ...
                            <div class="form-outline mb-4">
                              ...
                              <form:input type="password" id="form2Example17" class="form-control form-control-lg" name="passcu" path="passcu"/>
                                   <small><form:errors path="passcu" class="error"/></small>
                            </div>
                            <div class="form-outline mb-4">
                                <label class="form-label" for="form2Example17"><i class="fa-solid fa-lock"></i> Mật khẩu mới</label>
                              <form:input type="password" id="form2Example17" class="form-control form-control-lg" name="passmoi" path="passmoi"/>
                              <small><form:errors path="passmoi" class="error"/></small>
                              
                            </div>
                            <div class="form-outline mb-4">
                                <label class="form-label" for="form2Example17"><i class="fa-solid fa-lock"></i> Nhập lại khẩu mới</label>
                              <form:input type="password" id="form2Example17" class="form-control form-control-lg" name="repassmoi" path="repassmoi"/>
                              <small><form:errors path="repassmoi" class="error"/></small>

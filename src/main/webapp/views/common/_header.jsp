...
<header>
    ...
    <i class="fa-solid fa-user"></i> <s:message code="label.home.hi"/>,<!--  , --><c:if test="${account != null }"> ${account.username}</c:if>
    <c:if test="${account == null }"><s:message code="label.home.khach"/></c:if>
  </a>
  <c:choose>
